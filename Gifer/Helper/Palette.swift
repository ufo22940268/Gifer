...
public struct Palette
{
    ...
    public static var allColors = [.whit, Palette.Turquoise, Palette.Alizarin, Palette.Emerald, Palette.Amethyst, Palette.WetAsphalt, Palette.Nephritis, Palette.BelizeHole, Palette.Wisteria, Palette.Sunflower, Palette.Carrot, Palette.Clouds, Palette.Concentrate, Palette.Orange, Palette.Pumpkin, Palette.Pomegranate, Palette.Silver, Palette.Red, Palette.Pink, Palette.Purple, Palette.DeepPurple, Palette.Indigo, Palette.Blue, Palette.Cyan, Palette.Teal, Palette.LightGreen, Palette.Lime, Palette.Yellow, Palette.Amber, Palette.DeepOrange, Palette.Brown, Palette.Steel, Palette.PaleDogwood, Palette.Hazelnut, Palette.Kale, Palette.Lapis, Palette.Niagara, Palette.Grenadine, Palette.TawnyPort, Palette.BalletSlipper, Palette.Butterum, Palette.NavyPeony, Palette.NeutralGray, Palette.ShadedSpruce, Palette.GoldenLime, Palette.Marina, Palette.AutumnMaple]
}
